...
public class ExtensionFilterServiceImpl implements ExtensionFilterService {
    ...
    @Override
    @Transactional
    public ExtensionFilter addCustomExtensionFilter(String extension) {
    ...
    @Override
    @Transactional
    public ExtensionFilter removeCustomExtensionFilter(Long extensionId) {
    ...
    @Override
    @Transactional
    public ExtensionFilter enableFixedExtensionFilter(Long extensionId) {
    ...
    @Override
    public ExtensionFilter disableFixedExtensionFilter(Long extensionId) {
        var extensionFilter = extensionFilterRepository.findByIdAndDeleteYn(extensionId, YnType.N)
                .orElseThrow(() -> new ProcessException(ErrorCode.INVALID_EXTENSION_FILTER, "존재하지 않는 확장자입니다."));
    ...
    @Override
    @Transactional(readOnly = true)
    public boolean isDenyExtension(String fileName) {
